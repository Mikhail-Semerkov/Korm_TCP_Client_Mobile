...
namespace MenuActionBar
{
    ...
    {
        EditText txtId, txtNameFerms, txtNumberFerms, txtPodrazdelenie, txtNameAPP, txtTelefonStacionar, txtNameAdministrator, txtMobileAdministrator, txtNameRukovoditel, txtMobileRukovoditel, txtAPIPAddres, txtIpAddres1, txtIpAddres2, txtIpAddres3, txtIpAddres4, txtIpAddres5, txtIpAddres6, txtIpAddres7, txtIpAddres8, txtDescription, txtLocation;
        Button btnSave;
        ...
        protected override void OnCreate(Bundle savedInstanceState)
        {
            ...
            txtIpAddres1 = FindViewById<EditText>(Resource.Id.ipText);
        ...
        void buttonSave_Click(object sender, EventArgs e)
        {
            ...
            {
                Toast.MakeText(this, "Поле не может быть пустым. Введите имя фермы.", ToastLength.Short).Show();
                return;
            }
